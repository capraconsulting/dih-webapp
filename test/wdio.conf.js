...
var config = {
    ...
    cucumberOpts: {
        ...
        backtrace: true, // show full backtrace for errors
        compiler: ['js:babel-core/register'], // files with the given EXTENSION after requiring
        dryRun: false, // invoke formatters without executing steps
        failFast: false, // abort the run on first failure
        format: ['pretty'], // output format, optionally supply PATH to redirect formatter output.
        colors: true, // disable colors in formatter output
        snippets: true, // hide step definition snippets for pending steps
        source: true, // hide source uris
        profile: [], // (name) specify the profile to use
