...
export const GET_TRIPS_FOR_DESTINATION_REQUEST = 'GET_TRIPS_REQUEST';
export const GET_TRIPS_FOR_DESTINATION_SUCCESS = 'GET_TRIPS_SUCCESS';
export const GET_TRIPS_FOR_DESTINATION_FAILURE = 'GET_TRIPS_FAILURE';
